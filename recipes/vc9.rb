...
when 'x86_64'
  windows_package node['vc9']['x64']['tools']['pkg']['windows']['name'] do
    checksum node['vc9']['x64']['tools']['pkg']['windows']['sha256sum'] if node['vc9']['x64']['tools']['pkg']['windows']['sha256sum']
    source node['vc9']['x64']['tools']['pkg']['windows']['url']
    installer_type :custom
    options '/q'
  end
  windows_package node['vc9']['x86']['tools']['pkg']['windows']['name'] do
    checksum node['vc9']['x86']['tools']['pkg']['windows']['sha256sum'] if node['vc9']['x86']['tools']['pkg']['windows']['sha256sum']
